...
function App() {
  ...
  useDebounce(() => {setDebouncedSearchState(searchState)}, 500, [searchState]);
  ...
  const fetchMovies = async ( query = '') => {
    try{
      ...
      seterrorMessage('Error fetching Movies. Pleae check your internet and reload again.');
    }finally{
      setLoading(false);
    }
  }
  ...
  return (
    <main>
      ...
      <section className='all-movies'>
        <h2 className='text-start pt-2'> All Movies</h2>
        {loading ? (
